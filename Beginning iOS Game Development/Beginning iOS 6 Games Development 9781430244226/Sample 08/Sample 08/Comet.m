...
+(id)comet:(GameController *)controller withDirection:(float)aDirection andCenter:(CGPoint)aCenter{
    
    Comet* comet = [Comet comet:controller];
    [comet setCenter:aCenter];
    
    LinearMotion* motion = [LinearMotion linearMotionInDirection:aDirection AtSpeed:1];
    [motion setWrap:NO];
